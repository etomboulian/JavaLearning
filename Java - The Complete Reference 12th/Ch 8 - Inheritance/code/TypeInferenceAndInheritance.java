...
public class TypeInferenceAndInheritance {
    ...
    public static void main(String[] args) {
        ...
        // as MyClass (because the return type of getObj is MyClasd)
        // neigher mc2 nor mc3 can access the fields declared by
        // FirstDerivedClass or SecondDerivedClass
        // mc2.x = 10; // ERR: MyClass does not have an x field
        // mc2.y = 10; // ERR: MyClass does not have a y field
    }
}
